...
void self_and_line(void *arg)
{
    ...
    while (1)
    {
        ...
        else
        {
            ...
            left_duty_cycle = bound((60 - correction), lower_duty_cycle, higher_duty_cycle); // forward pwm  replace with motorcmd/motorpwm
            right_duty_cycle = bound((60 + correction), lower_duty_cycle, higher_duty_cycle);
